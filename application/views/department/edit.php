                        ...
                        <div class = "card">
                            <div class = "card-body">
                                <div class = "row">
                                    ...
                                    <input type="hidden" name="dept_id" value = "<?= $dataOfDept['0']['dept_id']; ?>">
                                    <input id="name" name="name" type="text" class="required form-control" placeholder = "Enter Department Name" value = "<?= $dataOfDept['0']['department_name']; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    $(document).ready(function(){
        ...
        $("#department_form").validate({
            ...
            submitHandler: function(form,event) {
                ...
                $.ajax({
                    type: "POST",
                    url: '<?= base_url(); ?>department/editDeptSubmit',
                    data: form_data,
                    processData:false, 
                    contentType:false, 
                    cache:false,
